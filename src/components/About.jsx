    ...
    <section id="about" className="about">
      <div className="about-container">
        ...
        <p>
          ...
          with web technologies, creating personal sites and blogs, and
          eventually taking my high school's computer science course the first
          year it was offered. There, I started to learn Java and develop
          foundational knowledge in CS; this also solidifified my desire to
          study CS in university! In university, I strove to learn as much as I
          could both in and out of class. There wasn't much in the cirriculum
          for web development at school, so classes primarily focused on
          programmatical thinking, algorithms, and data structures, while
          outside of class I focused on learning web technologies and trying to
        ...
        <ul>
          ...
          <li>
            ...
            (Swagger / OpenAPI, Markdown, Confluence, Notion, Cucumber /
            Gherkin)
          </li>
        ...
        <p>
          ...
          keen interest in expanding my horizons to work tangential to the web!
          I have recently been experimenting game development and low-level
          technologies. I happened to find a niche that manages to fit in both
          ...
          C++ skills by creating on a tilemap editor in the browser with React
          and C++ (via wasm).
        </p>
        ...
        <p>
          ...
          of 2023, I have been a volunteer mentor / coach for my old high
          school's robotics team. Prior to taking on this role, I knew nearly
          nothing of the sort, so I had to learn quick. With another coach, we
          work together to assist our students in building a robot every year in
          prepartion for competitions, held by{" "}
          ...
          part design, stylistic design, coding (driver and autonomous
          programs), building, testing, and iterating. But as a team we also
          need to consider: budget, finance sources, collaborating, advertising,
          learning + teaching, documentation, and room organizing. I personally
          find this a lot of fun!
        </p>

        <p>
          <strong>Music:</strong> I love playing music! I learned flute in high
          school so I can join the marching band, which I loved all 4 years I
          did it. I continued to play flute in orchestra and symphony in
          college. During that time, I also taught myself guitar and took a
          piano class. I also was in choir throughout high school, and took
          gospel choir for a couple years in college as well!
        </p>
        ...
        <p>
          ...
          volunteering at them even more! I feel that volunteering at
          conferences allows you to engage with the people and conference as a
          whole on a deeper level. In the past, I have volunteered at the UI/UX
          conference Smashing Conf, and typography conference Typographics. In
          the Hudson Valley, I was a co-organizer for Catskills Conf, the 3-day
          yearly conference that conjoins technology and nature, spawned from
          the Hudson Valley Tech Meetup. For Catskills Conf, I'd help work on
          the websites, manage attendee lists, communicate with speakers, assist
          with lodging, and do general tasks throughout the conference.
        </p>
        ...
        <p>
          This site's design is greatly inspired from the personal sites of
          olde. I tried to find a nice balance between modern and old design. I
          am aiming for the feel of hyper-dense yet *personal* content that
          early websites had, but with modern and more legible practices (and
          not using tables for layout 🤪). To me, a lot of the internet has
          become industrialized; many sites have taken a minimalist,
          "tried-and-true" approach to design, but they have lost so much
          personality and heart in the process. Though this very website is my
          professional advertisement of myself, I wish for it to also embody the
          things I enjoy and express itself as I feel I express myself.
        </p>

        <p>
          To achieve this feel, I sought to use various patterns alongside each
          other. This is to give the illusion of a clashing or dense feeling,
          but I selected each background image and modified them so they blend
          ...
          readability further, I try and give each block of text its own space
          to breathe, which deviates from old internet practices, but that's
          where the several "chaotic" background images makes up for.
        </p>
